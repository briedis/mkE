(function (window) {
    ...
    mkE.closure = function (fn, context) {
        var args = [];
        ...
        return function () {
            ...
            return fn.apply(context, args.concat(a));
        };
    };
    ...
    mkE.Base.prototype = {
        ...
        replace: function (node) {
            insertBefore(this.node, node);
            removeNode(node);
            return this;
        }
    };

    if (typeof window.mkE === 'undefined') {
        window.mkE = mkE;
    }
})(window);
